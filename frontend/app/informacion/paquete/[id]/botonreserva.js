...
const BotonReserva = ({ fechasFormateadas, id, autoReservado, hospedajeReservado }) => {
    ...
    <div className="container mx-auto w-full max-w-xl">
      ...
      {successMessages?.map((message, index) => (
        ...
        <div className="flex justify-center mt-6">
          <button
            className="px-5 py-2 rounded-md bg-orange-500 text-white font-bold text-base shadow-md hover:bg-orange-400 transition-colors duration-300 hover:cursor-pointer"
